      ...
      onConfirm: async () => {
        ...
        try {
          ...
          if (anyFailed) {
            ...
            window.dispatchEvent(new Event("opencohere-models-cleared"));
            showAlertDialog({
                      ...
                      steps: [
                        ...
                        },
                        {
                          ...
                          desc: t("settingsPage.general.waylandPaste.guide.group.step2Desc", {
                            defaultValue:
                              "Group changes only take effect after a new login session. Log out of your desktop and log back in, then reopen OpenCohere.",
                          }),
                        },
                      ],
                    },
